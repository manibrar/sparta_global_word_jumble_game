...
var wordLibrary = ["spartan", "browser", "richmond", "revolution", "programmer", "technology", "television", "friendship", "university", "discipline",  "validation", "spellcheck", "perfection",  "animation", "cyberspace", "kickboxing", "wildebeast",];
...
function win() {
  ...
  myStartButton.addEventListener('click', function(e) {
    ...
    resetter();
    myMessageDisplay.style.display = "none";
    myGuessPreview.style.fontSize = "4em";
  });
  ticker++;
  atimer = -1;
  lives = 3;
